...
private:
  ...
  vector<TH1D*> hNp_best_Ch, hNbest_Ch, hOccupancy, hTime, 
    hoccupancyXp, hoccupancyUp, hoccupancyVp, hoccupancyXm, hoccupancyUm, hoccupancyVm, hWireClust, hClusterSize;
  Int_t kMinHits;
  Int_t kmaxSeg;
...
// Arrays 
  ...
  void ProcessSegments( Int_t ,  Int_t *, Double_t ***, Double_t ***, Int_t **, Float_t **, Int_t , Double_t , Double_t ,Int_t ** , Double_t **, Double_t ***, Double_t ***, Double_t ***, Int_t *);
