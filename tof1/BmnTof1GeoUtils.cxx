...
Int_t		BmnTof1GeoUtils::ParseTGeoManager(bool useMCinput, TH2D* h1, bool forced)
{
	...
	while( (detectorNode = (TGeoNode*) it1->Next()) ) // detectors		
	{
		...
		while( (stripNode = (TGeoNode*) it2->Next()) )		// strips
		{
			...
			// initialize class called LStrip1, which is a TRectangle.
			// Then, go to edges of a strip and set A,B,C,D center, perp for
			// each strip, transforming from local coordinates to master coordinates
